...
const LoginComponent = () => {
  ...
  const handleChange = (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    setState({...loginState, [e.target.name]: e.target.value });
  };
  ...
  const handleSubmit = async (e: any) => {
    ...
    try {
      ...
      const response: LoginResponse = await login(loginState).unwrap();
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div className="form-floating">
              <input 
                ...
                name="username" 
                type="text" 
                className="form-control form-input text-center w-100" 
                id="floatingInput" 
