...
const SearchResult = () => {
  const { 
    ...
    isQueryChanged: boolean | undefined
  } = useAppSelector((state) => ({
    searchString: state.search.query,
    searchResults: state.search.searchResults ?? [],
    isQueryChanged: state.search.isQueryChanged,
  }));
      ...
      {searchString ? (
        <div className="search-result">
          ...
          <div className="search-result-empty">
            ...
            <p className="mt-4">
              {isQueryChanged ? 
                "No results for &quot;<strong>{searchString}</strong>&quot"
                : "Refactoring New Results please wait ...."
              }
            </p>
          </div>
        )}
